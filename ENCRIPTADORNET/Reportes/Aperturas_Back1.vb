...
Public Class Aperturas_Back
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.Aperturas_Back.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAperturas_Back
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Aperturas_Back = New Aperturas_Back()
        rpt.Site = Me.Site
        Return rpt
    End Function
