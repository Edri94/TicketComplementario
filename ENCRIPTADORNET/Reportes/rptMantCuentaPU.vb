...
Public Class rptMantCuentaPU
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.rptMantCuentaPU.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMantCuentaPU
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMantCuentaPU = New rptMantCuentaPU()
        rpt.Site = Me.Site
        Return rpt
    End Function
