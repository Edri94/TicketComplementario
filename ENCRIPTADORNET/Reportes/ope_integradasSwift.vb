...
Public Class ope_integradasSwift
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ope_integradasSwift.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.ope_integradasSwift.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedope_integradasSwift
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ope_integradasSwift = New ope_integradasSwift()
        rpt.Site = Me.Site
        Return rpt
    End Function
