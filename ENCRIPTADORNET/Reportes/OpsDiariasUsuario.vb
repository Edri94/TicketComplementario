...
Public Class OpsDiariasUsuario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.OpsDiariasUsuario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOpsDiariasUsuario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OpsDiariasUsuario = New OpsDiariasUsuario()
        rpt.Site = Me.Site
        Return rpt
    End Function
