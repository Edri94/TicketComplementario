...
Public Class RepSaldosxCuenta2020
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RepSaldosxCuenta2020.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.RepSaldosxCuenta2020.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_FECHAHOY() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRepSaldosxCuenta2020
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepSaldosxCuenta2020 = New RepSaldosxCuenta2020()
        rpt.Site = Me.Site
        Return rpt
    End Function
