...
Public Class ope_integradas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.ope_integradas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedope_integradas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ope_integradas = New ope_integradas()
        rpt.Site = Me.Site
        Return rpt
    End Function
