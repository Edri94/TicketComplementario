...
Public Class op_recibNoValidadas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "op_recibNoValidadas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.op_recibNoValidadas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedop_recibNoValidadas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As op_recibNoValidadas = New op_recibNoValidadas()
        rpt.Site = Me.Site
        Return rpt
    End Function
