...
Public Class rptCuentasCedAB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.rptCuentasCedAB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCuentasCedAB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCuentasCedAB = New rptCuentasCedAB()
        rpt.Site = Me.Site
        Return rpt
    End Function
