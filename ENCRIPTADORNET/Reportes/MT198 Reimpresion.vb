...
Public Class MT198_Reimpresion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.MT198 Reimpresion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMT198_Reimpresion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MT198_Reimpresion = New MT198_Reimpresion()
        rpt.Site = Me.Site
        Return rpt
    End Function
