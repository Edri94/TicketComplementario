...
Public Class CuentaBloqueada
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.CuentaBloqueada.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCuentaBloqueada
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CuentaBloqueada = New CuentaBloqueada()
        rpt.Site = Me.Site
        Return rpt
    End Function
