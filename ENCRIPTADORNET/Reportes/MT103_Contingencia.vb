...
Public Class MT103_Contingencia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.MT103_Contingencia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMT103_Contingencia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MT103_Contingencia = New MT103_Contingencia()
        rpt.Site = Me.Site
        Return rpt
    End Function
