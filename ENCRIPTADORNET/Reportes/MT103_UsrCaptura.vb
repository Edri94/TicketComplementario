...
Public Class MT103_UsrCaptura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.MT103_UsrCaptura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMT103_UsrCaptura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MT103_UsrCaptura = New MT103_UsrCaptura()
        rpt.Site = Me.Site
        Return rpt
    End Function
