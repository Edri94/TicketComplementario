...
Public Class rptOrdenesDePago
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.rptOrdenesDePago.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOrdenesDePago
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOrdenesDePago = New rptOrdenesDePago()
        rpt.Site = Me.Site
        Return rpt
    End Function
