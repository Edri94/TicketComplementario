...
Public Class Funcs_PermisosUsr
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.Funcs_PermisosUsr.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFuncs_PermisosUsr
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Funcs_PermisosUsr = New Funcs_PermisosUsr()
        rpt.Site = Me.Site
        Return rpt
    End Function
