...
Public Class Aper_por_FechaTest
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.Aper_por_FechaTest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAper_por_FechaTest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Aper_por_FechaTest = New Aper_por_FechaTest()
        rpt.Site = Me.Site
        Return rpt
    End Function
