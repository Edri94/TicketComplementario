...
Public Class aper_ticketTest
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.aper_ticketTest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedaper_ticketTest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As aper_ticketTest = New aper_ticketTest()
        rpt.Site = Me.Site
        Return rpt
    End Function
