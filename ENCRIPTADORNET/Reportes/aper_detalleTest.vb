...
Public Class aper_detalleTest
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.aper_detalleTest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedaper_detalleTest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As aper_detalleTest = New aper_detalleTest()
        rpt.Site = Me.Site
        Return rpt
    End Function
