...
Public Class Compra_TD_Overnight
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Compra_TD_Overnight.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.Compra_TD_Overnight.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCompra_TD_Overnight
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Compra_TD_Overnight = New Compra_TD_Overnight()
        rpt.Site = Me.Site
        Return rpt
    End Function
