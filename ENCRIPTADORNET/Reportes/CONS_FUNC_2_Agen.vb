...
Public Class CONS_FUNC_2_Agen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.CONS_FUNC_2_Agen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCONS_FUNC_2_Agen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CONS_FUNC_2_Agen = New CONS_FUNC_2_Agen()
        rpt.Site = Me.Site
        Return rpt
    End Function
