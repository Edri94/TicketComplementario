...
Public Class rptGestoresActCED
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.rptGestoresActCED.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGestoresActCED
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGestoresActCED = New rptGestoresActCED()
        rpt.Site = Me.Site
        Return rpt
    End Function
