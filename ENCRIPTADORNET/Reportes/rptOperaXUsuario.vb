...
Public Class rptOperaXUsuario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.rptOperaXUsuario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOperaXUsuario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOperaXUsuario = New rptOperaXUsuario()
        rpt.Site = Me.Site
        Return rpt
    End Function
