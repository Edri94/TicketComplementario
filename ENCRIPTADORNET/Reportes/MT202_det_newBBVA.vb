...
Public Class MT202_det_newBBVA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.MT202_det_newBBVA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMT202_det_newBBVA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MT202_det_newBBVA = New MT202_det_newBBVA()
        rpt.Site = Me.Site
        Return rpt
    End Function
