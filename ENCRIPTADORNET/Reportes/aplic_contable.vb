...
Public Class aplic_contable
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.aplic_contable.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedaplic_contable
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As aplic_contable = New aplic_contable()
        rpt.Site = Me.Site
        Return rpt
    End Function
