...
Public Class MT198_enviar_2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.MT198 enviar_2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMT198_enviar_2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MT198_enviar_2 = New MT198_enviar_2()
        rpt.Site = Me.Site
        Return rpt
    End Function
