...
Public Class PermisosBitacora
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.PermisosBitacora.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPermisosBitacora
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PermisosBitacora = New PermisosBitacora()
        rpt.Site = Me.Site
        Return rpt
    End Function
