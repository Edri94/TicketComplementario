...
Public Class Aperturas_BackTest
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.Aperturas_BackTest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAperturas_BackTest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Aperturas_BackTest = New Aperturas_BackTest()
        rpt.Site = Me.Site
        Return rpt
    End Function
