...
Public Class COMPRAS_TD_LISTA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.COMPRAS_TD_LISTA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCOMPRAS_TD_LISTA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As COMPRAS_TD_LISTA = New COMPRAS_TD_LISTA()
        rpt.Site = Me.Site
        Return rpt
    End Function
