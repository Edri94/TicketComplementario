...
Public Class Aper_por_Fecha
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket.Aper_por_Fecha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAper_por_Fecha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Aper_por_Fecha = New Aper_por_Fecha()
        rpt.Site = Me.Site
        Return rpt
    End Function
